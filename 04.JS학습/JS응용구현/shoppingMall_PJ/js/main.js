...
function loadFn() {
    ...
    abtn[0].onclick = () => {
        ...
        prot = 1;
        setTimeout(() => (prot = 0), 800);
        // 1. 맨 뒤요소를 잘라서 맨 앞으로 이동한다.
        // 대상: slide 변수 -> ul#slide
        // 사용메서드: insertBefore(넣을놈, 넣을놈 전놈)
        // 현재 li자식요소 수집하기!
    ...
    // 고유순번용 속성을 만들어서 넣어준다.
    // w3c에서 허용한 사용자 지정속성명은 반드시data- 로 시작해야함
    // 우리는 "data-seq"라는 이름을 쓰자
    ...
    const chgIndic = (idx) => {
        ...
        // getAttribute(속성명) -> 속성값 읽어오는 JS 내장 함수
        console.log(cseq);
